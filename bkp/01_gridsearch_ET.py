...
base_path = "C:/Users/palbani/Downloads/Data Mining Cup/"
...
learners = [
    {
        ...
        "params": {
            "max_depth": [15],
            "max_features": ["auto", 0.2, 0.1, 0.05, 0.001],
...
resultados_path = target_path + "resultados_ET.xlsx"
probs_path = target_path + "fold_3_ET.p"
